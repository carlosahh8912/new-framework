...
class Framework {
  ...
  // Desarrollado por Carlos Hurtado
  /**
   * 
   * Carlos Hurtado / carlos.ahh@hotmail.com
   * 
   *
   * @var string
   */
  private $framework    = 'Framework'; // Ahora este solo será el nombre idenficador del framework y no el nombre del sistema como tal
  private $version      = '0.1';         // versión actual del framework y no del sistema en desarrollo
  private $lng          = 'es';
  private $uri          = [];
  private $use_composer = true; // Uso de composer simepre debe estar en true
